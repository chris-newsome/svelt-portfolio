...
<header class="top-0 z-50 md:sticky md:top-0 relative">
	<nav class="md:mt-0">
		<div
			class="flex flex-col justify-between rounded-b-lg bg-[#c8e6c9] px-4 py-2 md:m-4 md:flex-row md:items-center md:rounded-xl"
		>
			...
			<!-- Destktop Nav -->
			<ul class="relative z-50 hidden flex-row items-center gap-1 transparant py-0 md:flex">
				{#each settings.data.nav_item as { label, link }}
					<li>
